...
public class DependencyStructureMatrixTest {
	...
	public void detectCycle() {
		...
		assertThat(dsm.getUpwardDependencies()).hasSize(1).containsExactly(nodes.get(3).getOutgoingDependencyTo(nodes.get(2)));
		
		
		System.out.println(dsm.getOrderedNodes());
		System.out.println(dsm.getUpwardDependencies());
	}
}
